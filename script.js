...
/* --- Generic 3D Carousel Logic --- */
function init3DCarousel(carouselId, nextBtnClass, prevBtnClass, hasModal = false) {
    ...
    const updateCoverflow = () => {
        ...
        const txMultiplier = isMobile ? 180 : 250;
...
window.addEventListener('load', () => {
    init3DCarousel('education-carousel', '.edu-next', '.edu-prev', false);
    init3DCarousel('cert-carousel', '.cert-nav-btn.next', '.cert-nav-btn.prev', true);
});
